...
export default function SelfTaskForm({
  ...
  const handleSelectProject = (values: string[]) => {
    ...
    const currentUserIds = isSequential
      ? orderedUserIds
                          ...
                          >
                            <div className="p-4 space-y-2 max-h-[280px] overflow-y-auto">
                              {projects.map((project) => (
                                <div
                                  key={project.id}
                                  className="flex items-center space-x-3 hover:bg-slate-50 p-2.5 rounded-lg transition-colors"
                                >
                                  <Checkbox
                  ...
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-slate-600">
                        Enable this to assign tasks in a specific order. Each
                        team member must complete their part before the next
                        person can start.
                      </p>
                    </div>
                    <Switch
                            ...
                            {users.map((user) => (
                              ...
                              >
                                <Checkbox
                                  ...
                                  checked={
                                    isSequential
                                      ? orderedUserIds.includes(user.id)
